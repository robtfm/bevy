...
impl render_graph::Node for ImageCopyDriver {
    fn run(
        ...
        for image_copier in image_copiers.iter() {
            ...
            let block_size = src_image.texture_descriptor.format.block_copy_size(None).unwrap();
            ...
            let padded_bytes_per_row = RenderDevice::align_copy_bytes_per_row(
                (src_image.texture_descriptor.size.width as usize / block_dimensions.0 as usize) * block_size as usize,
            );
